...
urlpatterns = [
    ...
    url(r'^nfv/deleteCatalog/$', "nfv.views.deleteCatalog"),
    url(r'^nfv/devops/$', "nfv.views.devops"),
    url(r'^$', "nfv.views.login_auth"),
   # url(r'^nfv/test/$', "nfv.views.test"),


    #url(r'^nfv/admin/$', "Admin.html"),
 #   url(r'^nfv/$', "login"),
